...
QMAKE    = /usr/bin/qmake
KickAssGUI.xcodeproj/project.pbxproj: KickAssGUI.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-xcode -o KickAssGUI.xcodeproj/project.pbxproj KickAssGUI.pro
